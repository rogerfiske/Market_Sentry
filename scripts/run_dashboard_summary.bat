@echo off
REM Market_Sentry - Run Dashboard Summary
REM This script prints a text-based dashboard summary using local data only.
...
set "LOG_FILE=logs\scheduled\dashboard_summary_%TIMESTAMP%.log"

echo ================================================== >> "%LOG_FILE%"
echo Market_Sentry Dashboard Summary >> "%LOG_FILE%"
...
echo. >> "%LOG_FILE%"
echo Running: marketsentry dashboard-summary >> "%LOG_FILE%"
echo ================================================== >> "%LOG_FILE%"

python -c "from marketsentry.cli import app; app()" dashboard-summary >> "%LOG_FILE%" 2>&1
