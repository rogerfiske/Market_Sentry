...
python -m marketsentry persist-portfolio-trend-alerts >> %LOGFILE% 2>&1

python -m marketsentry export-portfolio-trend-alert-run-comparison --format both >> %LOGFILE% 2>&1
